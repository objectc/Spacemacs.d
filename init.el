...
values."
  (setq-default
   ...
   '(nginx
     ...
     imenu-list
     (conda :variables
            conda-anaconda-home "/Users/guibintang/opt/anaconda3/"
...
`dotspacemacs/user-config' first."
  ;; disable pyls for lsp to use mspyls
...
you should place your code here."
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline "~/Documents/org/gtd/gtd.org" "Tasks")
           "* TODO %?\n  %i\n  %a")
          ("j" "Journal" entry (file+datetree "~/Documents/org/gtd/journal.org")
           "* %?\nEntered on %U\n  %i\n  %a")))
  (setq org-mobile-directory "~/Library/Mobile Documents/iCloud~com~mobileorg~mobileorg/Documents")

  ;;region(selection) face for differ highlight and selection
  (set-face-attribute 'region nil :background "#3b314d")
  ;; sphinx-doc
  ...
  (push "./custom/" load-path)
  (autoload 'org-paste-clipboard "~/.spacemacs.d/custom/custom-func.el" "paste-clipboard" t)
  ;;iedit-cleanup void bug
  ...
  ;; ;;yasnippet
  (add-to-list 'yas-snippet-dirs "~/project/yasnippet-snippets/snippets")
...
(custom-set-variables
 ...
 '(org-agenda-files '("~/Documents/org/gtd/gtd.org"))
